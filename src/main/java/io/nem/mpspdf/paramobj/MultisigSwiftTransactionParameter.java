...
public class MultisigSwiftTransactionParameter {
	...
	private String multisigPrivateKey;
	
	public String getMultisigPrivateKey() {
		return multisigPrivateKey;
	}
	public void setMultisigPrivateKey(String multisigPrivateKey) {
